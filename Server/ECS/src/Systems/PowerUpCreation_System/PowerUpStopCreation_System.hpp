...
#ifndef POWERUPSTOPCREATION_SYSTEM_HPP_
#define POWERUPSTOPCREATION_SYSTEM_HPP_
...
class PowerUpStopCreation_System {
    public:
        PowerUpStopCreation_System();
        ~PowerUpStopCreation_System() = default;
        Entity create_PowerUpStop(Registry &reg);
...
#endif /* !POWERUPSTOPCREATION_SYSTEM_HPP_ */
