...
#ifndef POWERUPShieldCREATION_SYSTEM_HPP_
#define POWERUPShieldCREATION_SYSTEM_HPP_
...
class PowerUpShieldCreation_System {
    public:
        PowerUpShieldCreation_System();
        ~PowerUpShieldCreation_System() = default;
        Entity create_PowerUpShield(Registry &reg);
...
#endif /* !POWERUPSPEEDCREATION_SYSTEM_HPP_ */
